...
\begin{align*}
    ...
    = &f_{\mathbf{B}\eta + \zeta} \left(\mathbf{B}\mathbf{b} - \mathbf{A}\mathbf{x} \right)
\end{align*}
...
\begin{align*}
    ...
    = & \frac{\exp\left[ - (\mathbf{Bb} - \mathbf{A}\mathbf{x})^H \Sigma_{\mathbf{B}\eta+\zeta} ^{-1}(\mathbf{Bb} - \mathbf{A}\mathbf{x})\right]}{(\pi)^{\tilde{M}QN_\mathrm{frames}} \det{ |\Sigma_{\mathbf{B}\eta+\zeta}|}}
\end{align*}
